...
SELECT
	...
	uri_remotepath_exists('https://www.darold.net/uri_test.txt') as remotepath_true,
	uri_remotepath_exists('https://www.darold.net/uri_test2.txt') as remotepath_false,
	uri_path_exists('https://www.darold.net/uri_test.txt') as rpath_exists_true,
	uri_path_exists('https://www.darold.net/uri_test2.txt') as rpath_exists_false,
	...
	uri_remotepath_content_type('https://www.darold.net/uri_test.html') as remote_content_type,
	...
	uri_localpath_size('PG_VERSION') as local_size,
	uri_remotepath_size('https://www.darold.net/uri_test.html') as remote_size,
	uri_path_size('PG_VERSION') as lpath_size,
